...
export default [
  ...
  {
    path: '/blog/authors/christian',
    component: ComponentCreator('/blog/authors/christian', '4ca'),
    exact: true
  },
  {
    path: '/blog/authors/loredana',
    component: ComponentCreator('/blog/authors/loredana', 'b98'),
    exact: true
  },
  {
    path: '/index_',
    component: ComponentCreator('/index_', '9b4'),
    exact: true
  },
  {
    path: '/markdown-page',
